...
class ModelSaleOrder extends Model {
	...
	public function getTotalOrders($data = array()) {
		...
		if (isset($data['filter_order_status_id']) && !is_null($data['filter_order_status_id'])) {
			...
			$sql .= " WHERE order_status_id NOT IN ('0', '1', '2', '7', '8', '9', '10', '11', '12', '13', '15', '16')";
		}
...
public function getTotalOrderByDay() {
	...
	public function getTotalOrderByYear() {
      	$query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order` WHERE order_status_id NOT IN ('0', '7', '8', '9', '10', '11', '13') AND YEAR(date_added) = YEAR(NOW()) AND YEAR(date_added) = YEAR(NOW())");
		return $query->row['total'];
	}
	...
	public function getTotalSales() {
		$query = $this->db->query("SELECT SUM(total) AS total FROM `" . DB_PREFIX . "order` WHERE order_status_id NOT IN ('0', '1', '2', '7', '8', '9', '10', '11', '12', '13', '15', '16')");
	...
	public function getTotalSalesByMonth($month) {
      	$query = $this->db->query("SELECT SUM(total) AS total FROM `" . DB_PREFIX . "order` WHERE order_status_id NOT IN ('0', '1', '2', '7', '8', '9', '10', '11', '12', '13') AND MONTH(date_added) = MONTH(NOW()) AND YEAR(date_added) = YEAR(NOW())");
		return $query->row['total'];
	}
	public function getTotalSalesByYear($year) {
		$query = $this->db->query("SELECT SUM(total) AS total FROM `" . DB_PREFIX . "order` WHERE order_status_id NOT IN ('0', '1', '2', '7', '8', '9', '10', '11', '12', '13') AND YEAR(date_added) = '" . (int)$year . "'");
