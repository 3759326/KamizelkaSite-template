...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		$this->data['button_sizegrid'] = $this->language->get('button_sizegrid');
		$this->data['sizegrid_link'] = $this->language->get('sizegrid_link');
		...
		$this->document->setTitle($product_info['name']);
			...
			if ($product_info['image']) {
                ...
                if (isset($this->request->server['HTTPS']) && (($this->request->server['HTTPS'] == 'on') || ($this->request->server['HTTPS'] == '1'))) {
                    $http = $this->config->get('config_ssl') . 'image/';
                } else {
                    $http = $this->config->get('config_url') . 'image/';
                }
                ...
                if (isset($settings['labelimage_product']) && $settings['labelimage_product']=='1'){
                    if ($product_info['topleft_png'] || $product_info['topright_png'] || $product_info['bottomleft_png'] || $product_info['bottomright_png']){
                        require_once DIR_APPLICATION . '/model/tool/labelimage.php';
                        $label = new Labelimage();
                        $this->data['thumb'] = $label->setLabelImage($this->data['thumb'], $product_info['topleft_png'], $product_info['topright_png'], $product_info['bottomleft_png'], $product_info['bottomright_png'],$http,$product_info['image'],$product_id, $this->config->get('config_image_thumb_width'), $this->config->get('config_image_thumb_height'));
                    }
                }
                //end
