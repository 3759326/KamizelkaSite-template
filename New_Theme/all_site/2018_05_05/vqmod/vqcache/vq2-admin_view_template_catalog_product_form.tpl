...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-profile"><?php echo $tab_profile; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><!--farid--> <?php echo $labelimage ? '<a href="#tab-label">Product Sticker</a>':null; ?><!--end farid--><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
        ...
        <div id="tab-links">
          <table class="form">
            ...
            <tr>
              ...
              <td><select class="cat_sel" name="category_select">
                  <option selected value="0" ><?php echo $text_none; ?></option>
...
//alert ($(".cat_sel :selected").text());
if ($(".cat_sel :selected").text()!='<?php echo $text_none; ?>'){
$('#product-category').append('<div id="product-category' + $(".cat_sel :selected").val() + '">' + $(".cat_sel :selected").text() + '<img src="view/image/delete.png" alt="" /><input type="hidden" name="product_category[]" value="' + $(".cat_sel :selected").val() + '" /></div>');
$(".cat_sel [value='0']").attr("selected", "selected");
}
});
