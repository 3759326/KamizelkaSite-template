...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		$this->data['text_address2cap'] = $this->language->get('text_address2cap');
		$this->data['text_address2line'] = $this->language->get('text_address2line');
		$this->data['text_address3cap'] = $this->language->get('text_address3cap');
		$this->data['text_address3line'] = $this->language->get('text_address3line');
		$this->data['text_telephone'] = $this->language->get('text_telephone');
		$this->data['text_telephone1'] = $this->language->get('text_telephone1');
		$this->data['text_telephone2'] = $this->language->get('text_telephone2');
		...
		$this->data['telephone1'] = $this->config->get('config_telephone1');
