    ...
    <div class="right">
      ...
      <div class="cart">
        ...
        <div class="product-add-list-compare">
		  ...
		  <li><a class="product-size-grid" onclick="showSizeGrid();"><?php echo $button_sizegrid; ?></a></li>
        </div> 
...
$('#button-cart').bind('click', function() {
	$.ajax({
        ...
        if (json['error']['profile']) {
			...
			if (json['success']) {
				$('#notification').html('<div class="success" style="display: none;">' + json['success'] + 'Diem' +'<img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div>');
