...
<div id="content">
  ...
  <div class="breadcrumb">
    ...
    <?php } ?>
	<div class="product-compare-prod" style="float: right;"><a href="<?php echo $compare; ?>" id="compare-total"><?php echo $text_compare; ?></a></div>
  ...
  <div class="product-info">
    ...
    <div class="left">
      ...
      <?php } ?>
		...
		<?php if ($quantity<=0){ ?>
	  <div class="product-ribbon-sold"></div>
	 <?php } ?>
      ...
      <div class="image-additional">
        ...
        <a href="<?php echo $image['popup']; ?>" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '<?php echo $image['thumb']; ?>' "><img src="<?php echo $image['thumb']; ?>" width="66" height="100" alt="<?php echo $heading_title; ?>" /></a>
        <?php } ?>
      </div>
      <?php } ?>
  ...
  <div id="tab-review" class="tab-content">
    <div id="review"></div>
	<a class="write-review" onclick="ShowWrite();"><?php echo $text_write; ?></a>
  ...
  <!-- End tabs //-->
      ...
      <div class="description">
        ...
        <?php } ?>
        <span><?php echo $text_stock; ?></span> <span class="quantity" ><?php echo $stock; ?></span>
      </div>
      <!-- End description //--> 
      ...
      <?php } ?>
      <!-- End discounts //-->
	<a class="product-size-grid" onclick="showSizeGrid();"><?php echo $button_sizegrid; ?></a>
      <!-- Begin options //-->
      <?php if ($profiles): ?>
      <div class="option">
      ...
      <div class="cart">
        ...
        <div class="product-add-list-compare">
          <li><a class="product-add-to-wishlist" onclick="addToWishList('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></a></li>
          <li><a class="product-add-to-compare" onclick="addToCompare('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a></li>
      ...
      <div class="review">
        <div><img src="catalog/view/theme/shopycart/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />
          <br />
          <br />
        <a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;</div>
        
		 <!-- old Write-review -->
		
		<div class="share"><!-- AddThis Button BEGIN -->
          <div class="addthis_default_style"> <a class="addthis_button_email"></a> <a class="addthis_button_facebook"></a> <a class="addthis_button_twitter"></a></div>
...
<script type="text/javascript"><!--
$(document).ready(function() {
 var quant = "<?php echo $quantity; ?>";
 var s_status = "<?php echo $status_id; ?>";
...
<?php } ?>
<script type="text/javascript"><!--
$('#review .pagination a .review-write').live('click', function() {
...
/* рабочий вариант с файлом*/
/* $('#notification').load('sizegrid.html'); 
	$('.success').fadeIn(1000);
	}
 */
...
$.lebnikLoad('#sizetable', 'index.php?route=information/information&information_id=8', function(r){
		...
		$('#notification').html('<div class="sizegrid-notify" style="display: none;">' + $(r).html() + '<img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div>');
		$('.sizegrid-notify').append('<div style="padding-top: 15px;text-align: center;"><a href="http://kamizelka.in.ua/size_grid.html"  style="font-size: 16px;">'+'<?php echo $sizegrid_link; ?>'+'</a></div>');
