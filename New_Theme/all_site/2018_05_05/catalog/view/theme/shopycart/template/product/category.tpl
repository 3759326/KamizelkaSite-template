      ...
      <?php foreach ($products as $product) { ?>
        ...
        <div>
          ...
          <div class="boxgrid-bottom">
			...
			<?php echo "<div class=\"price\"  id=\""?><?php echo $product['product_id']; ?><?php echo "\">" ?>
	             ...
	             <div class="sold-cat"><h2 style="color: #717171;">ПРОДАНО</h2></div>
	 <?php } ?>
...
<script type="text/javascript"><!--
 ...
 var prod_id = "#<?php echo $product['product_id']; ?>";

 
 if (quant <= 0) {
  
 console.log(prod_id);
 console.log("<?php echo $product['name']; ?>");
 console.log (quant);
