...
$_['heading_title'] = 'Обмін або повернення товару'; #46314
...
$_['text_description'] = '<p>Якщо у Вас виникли проблеми з товаром, які неможливо вирішити за допомогою технічної підтримки або відділу з продажів, Ви можете повернути його назад на протязі 14-ти днів з дня отримання (згідно Закону України «Про захист прав споживачів»). </p>
<p>Для цього достатньо заповнити форму повернення і відправити нам товар зручним для Вас способом. Ми  обробимо Ваш запит протягом трьох робочих днів з дня отримання товару і повернемо кошти за умов дотримання всіх умов повернення.</p>
...
<p>Послуги доставки при поверненні товару сплачує покупець.</p>'; #46778
