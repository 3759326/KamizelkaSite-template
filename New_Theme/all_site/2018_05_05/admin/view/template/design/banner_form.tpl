        ...
        <table id="images" class="list">
          ...
          <tbody id="image-row<?php echo $image_row; ?>">
            <tr>
			 ...
			 <input type="text" class="color_txt<?php echo $image_row; ?>" name="banner_image[<?php echo $image_row; ?>][txt_color]" value="<?php echo $banner_image['txt_color']; ?>" /> <input type='text' class="color_btn<?php echo $image_row; ?>"/></br>
			 <script type="text/javascript"> // ColorPiker
				$(document).ready(function(){
					$('.color_btn<?php echo $image_row; ?>').spectrum({
						color: "#f00",
						showPalette: true,
						palette: [
						['black', 'white', '#9bcedf','#476AAA'],
					],
						change: function(color) {
							$(".color_txt<?php echo $image_row; ?>").attr('value', color.toHexString());
						}
					});
				});
			</script>
...
<script type="text/javascript" src="view/javascript/spectrum.js"></script>
