  ...
  <div class="box">
    ...
    <div class="content discounts">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
         ...
         <div id="discount-total" class="tabs-content">
          <table class="form">
               <h2 href="#discount-total" id="tab-discount-total" class="tab" onClick="selectTab('discount-total');"><?php echo $text_discount_total;?></h2>
        
          <?php $discount_type = 'total';?>
            <tbody>
              <tr>
                <td><label for="discount_<?php echo $discount_type;?>_enabled"><?php echo $text_enabled_discount;?></label><br /><span class="help"><?php echo $text_enabled_discount_i;?></span></td>
                <td>
                  <input type="checkbox" name="discount[<?php echo $discount_type;?>][enabled]" id="discount_<?php echo $discount_type;?>_enabled" value="1" onClick="setFullTimeDiscount('<?php echo $discount_type;?>');"<?php if(isset($discount_data[$discount_type]['enabled']) AND $discount_data[$discount_type]['enabled'] == 1){echo ' checked="checked"';} ?> />
                </td>
              </tr>
              <tr>
              ...
              <tr><td class="center" style="width: 135px;"><strong><?php echo $text_discount_option;?></strong></td>
                  <td align="left">
                      <select name="discount[<?php echo $discount_type;?>][discount_option]">
                          <option <?php if(isset($discount_data[$discount_type]['discount_option']) && $discount_data[$discount_type]['discount_option']==1) { echo 'selected';} ?> value="1"><?php echo $text_discount_option_all ?></option>
                           <option <?php if(isset($discount_data[$discount_type]['discount_option']) && $discount_data[$discount_type]['discount_option']==2) { echo 'selected';} ?> value="2"><?php echo $text_discount_option_leave ?></option>
          ...
          <h2 href="#discount-category" id="tab-discount-category" class="tab" onClick="selectTab('discount-category');"><?php echo $text_discount_category;?></h2>
         
        
      <?php $discount_type = 'category';?>
        <div id="discount-category" class="tabs-content">
           <table id="category_discount" class="list">
            <thead>
              <tr>
                ...
                <td class="center" style="width: 135px;"><?php echo $text_discount_option;?>:</td>
            ...
            <?php if(isset($discount_data[$discount_type])){ ?>
              <?php foreach($discount_data[$discount_type] as $category){?>
                <tr id="category-discount-<?php echo $category_number;?>">
                  ...
                  <td class="center">
                    - <input required type="text" name="discount[<?php echo $discount_type;?>][<?php echo $category_number;?>][discount_value]" value="<?php if(isset($category['discount_value'])){echo $category['discount_value'];}?>" id="discount_<?php echo $discount_type;?>_category_<?php echo $category_number;?>_type_value" size="10"<?php if(isset($error[$discount_type][$category_number]['discount_value'])){echo ' class="error-field"';}?> />
                    <span id="discount_<?php echo $discount_type;?>_category_<?php echo $category_number;?>_type_character"></span>
                  </td>
                  <td align="center">
                      <select name="discount[<?php echo $discount_type;?>][<?php echo $category_number;?>][discount_option]">
                          <option <?php if($category['discount_option']==1) { echo 'selected';} ?> value="1"><?php echo $text_discount_option_all ?></option>
                           <option <?php if($category['discount_option']==2) { echo 'selected';} ?> value="2"><?php echo $text_discount_option_leave ?></option>
                            
                            
                      </select>
                  </td>
                  <td align="center"><a class="button" onclick="$('#category-discount-<?php echo $category_number;?>').remove();"><span><?php echo $text_remove;?></span></a></td>
                </tr>
              <?php $category_number++;} ?>
            <?php } ?>
            </tbody>
            <tfoot>
              <tr>
                <td colspan="6" class="right"><a onclick="addCategory();" class="button"><span><?php echo $text_add_category;?></span></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
         ...
         <h2 href="#discount-manufacturer" id="tab-discount-manufacturer" class="tab" onClick="selectTab('discount-manufacturer');"><?php echo $text_discount_manufacturer;?></h2>
          
        
      <?php $discount_type = 'manufacturer';?>
        <div id="discount-manufacturer" class="tabs-content">
           <table id="manufacturer_discount" class="list">
            ...
            <?php if(isset($discount_data[$discount_type])){ ?>
              <?php foreach($discount_data[$discount_type] as $manufacturer_data){?>
                <tr id="manufacturer-discount-<?php echo $manufacturer_number;?>">
                  ...
                  <td class="center">
                    - <input required type="text" name="discount[<?php echo $discount_type;?>][<?php echo $manufacturer_number;?>][discount_value]" value="<?php if(isset($manufacturer_data['discount_value'])){echo $manufacturer_data['discount_value'];}?>" id="discount_<?php echo $discount_type;?>_manufacturer_<?php echo $manufacturer_number;?>_type_value" size="10"<?php if(isset($error[$discount_type][$manufacturer_number]['discount_value'])){echo ' class="error-field"';}?> /><span id="discount_<?php echo $discount_type;?>_manufacturer_<?php echo $manufacturer_number;?>_type_character"></span>
                  </td>
                  <td align="center">
                      <select name="discount[<?php echo $discount_type;?>][<?php echo $manufacturer_number;?>][discount_option]">
                          <option <?php if($manufacturer_data['discount_option']==1) { echo 'selected';} ?> value="1"><?php echo $text_discount_option_all ?></option>
                           <option <?php if($manufacturer_data['discount_option']==2) { echo 'selected';} ?> value="2"><?php echo $text_discount_option_leave ?></option>
                          
                            
                      </select>
                  </td>
                  <td align="center"><a class="button" onclick="$('#manufacturer-discount-<?php echo $manufacturer_number;?>').remove();"><span><?php echo $text_remove;?></span></a></td>
                </tr>
            ...
            <tfoot>
              <tr>
                <td colspan="6" class="right"><a onclick="addManufacturer();" class="button"><span><?php echo $text_add_manufacturer;?></span></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        <h2 href="#discount-customer" id="tab-discount-customer" class="tab" onClick="selectTab('discount-customer');"><?php echo $text_discount_customer_group;?></h2>   
      <?php $discount_type = 'customer_group';?>
        <div id="discount-customer" class="tabs-content">
           <table id="customer-group_discount" class="list">
            ...
            <?php if(isset($discount_data[$discount_type])){ ?>
              <?php foreach($discount_data[$discount_type] as $customer_group_data){?>
                <tr id="customer-discount-<?php echo $customer_group_number;?>">
                  ...
                  <td class="center">
                    - <input required type="text" name="discount[<?php echo $discount_type;?>][<?php echo $customer_group_number;?>][discount_value]" value="<?php if(isset($customer_group_data['discount_value'])){echo $customer_group_data['discount_value'];}?>" id="discount_<?php echo $discount_type;?>_customer_group_<?php echo $customer_group_number;?>_type_value" size="10"<?php if(isset($error[$discount_type][$customer_group_number]['discount_value'])){echo ' class="error-field"';}?> /><span id="discount_<?php echo $discount_type;?>_customer_group_<?php echo $customer_group_number;?>_type_character"></span>
                  </td>
                  <td align="center">
                      <select name="discount[<?php echo $discount_type;?>][<?php echo $customer_group_number;?>][discount_option]">
                          <option <?php if($customer_group_data['discount_option']==1) { echo 'selected';} ?> value="1"><?php echo $text_discount_option_all ?></option>
                           <option <?php if($customer_group_data['discount_option']==2) { echo 'selected';} ?> value="2"><?php echo $text_discount_option_leave ?></option>
                           
                            
                      </select>
                  </td>
                  <td align="center"><a class="button" onclick="$('#customer-discount-<?php echo $customer_group_number;?>').remove();"><span><?php echo $text_remove;?></span></a></td>
                </tr>
            ...
            <tfoot>
              <tr>
                <td colspan="6" class="right"><a onclick="addCustomerGroup();" class="button"><span><?php echo $text_add_customer_group;?></span></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
...
function addCategory(){
  ...
  var html = '';
      ...
      html    += '  </td>';
      html    += '  <td class="center">';
      html    += '    - <input required type="text" name="discount[category]['+category_number+'][discount_value]" id="discount_category_category_'+category_number+'_type_value" size="10" /><span id="discount_category_category_'+category_number+'_type_character">%</span>';
      html    += '  </td>';
      html      +='<td align="center"><select name="discount[category]['+category_number+'][discount_option]"><option value="1"><?php echo $text_discount_option_all ?></option><option value="2"><?php echo $text_discount_option_leave ?></option></select></td>';
      html    += '  <td align="center"><a class="button" onclick="$(\'#category-discount-'+category_number+'\').remove();""><span><?php echo $text_remove;?></span></a></td>';
      html    += '</tr>';
...
function addManufacturer(){
  ...
  var html = '';
      ...
      html    += '</td>';
      html    += '<td class="center">';
      html    += '  - <input  required type="text" name="discount[manufacturer]['+manufacturer_number+'][discount_value]" id="discount_<?php echo $discount_type;?>_manufacturer_'+manufacturer_number+'_type_value" size="10" /><span id="discount_manufacturer_manufacturer_'+manufacturer_number+'_type_character">%</span>';
      html    += '</td>';
      html      +='<td align="center"><select name="discount[manufacturer]['+manufacturer_number+'][discount_option]"><option value="1"><?php echo $text_discount_option_all ?></option><option value="2"><?php echo $text_discount_option_leave ?></option> </select></td>';
      html    += '<td align="center"><a class="button" onclick="$(\'#manufacturer-discount-'+manufacturer_number+'\').remove();"><span><?php echo $text_remove;?></span></a></td>';
      html    += '</tr>';
...
function addCustomerGroup(){
  ...
  var html = '';
      ...
      html    += '</td>';
      html    += '<td class="center">';
      html    += '  - <input required type="text" name="discount[customer_group]['+customer_group_number+'][discount_value]" id="discount_customer_group_customer_group_'+customer_group_number+'_type_value" size="10" /><span id="discount_customer_group_customer_group_'+customer_group_number+'_type_character">%</span>';
      html    += '</td>';
       html      +='<td align="center"><select name="discount[customer_group]['+customer_group_number+'][discount_option]"><option value="1"><?php echo $text_discount_option_all ?></option><option value="2"><?php echo $text_discount_option_leave ?></option></select></td>';
      html    += '<td align="center"><a class="button" onclick="$(\'#customer-discount-'+customer_group_number+'\').remove();"><span><?php echo $text_remove;?></span></a></td>';
      html    += '</tr>';
