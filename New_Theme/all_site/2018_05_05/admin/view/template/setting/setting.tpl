        ...
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
			 ...
			 <tr>
              <td><span class="required">*</span> <?php echo $entry_telephone1; ?></td>
              <td><input type="text" name="config_telephone1" value="<?php echo $config_telephone1; ?>" />
                <?php if ($error_telephone1) { ?>
                <span class="error"><?php echo $error_telephone1; ?></span>
                <?php } ?></td>
            </tr>
			 <tr>
              <td><span class="required">*</span> <?php echo $entry_telephone2; ?></td>
              <td><input type="text" name="config_telephone2" value="<?php echo $config_telephone2; ?>" />
                <?php if ($error_telephone2) { ?>
                <span class="error"><?php echo $error_telephone2; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
