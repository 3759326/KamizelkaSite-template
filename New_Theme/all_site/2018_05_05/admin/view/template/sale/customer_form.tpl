  ...
  <div class="box">
    ...
    <div class="content">
      <div id="htabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a>
        ...
        <?php } ?>
        <a href="#tab-ip"><?php echo $tab_ip; ?></a><a href="#tab-order"><?php echo $tab_order; ?></a></div>
          ...
          <table class="list">
            <thead>
              <tr>
			    ...
			    <td class="center"><?php echo $column_order_date; ?></td>
                <td class="center"><?php echo $column_order_status; ?></td>
				<td class="center"><?php echo $column_order_total; ?></td>
            ...
            <tbody>
              ...
              <tr>
				<td class="center"><a href="<?php echo $order['view_order']; ?>"><b>#<?php echo $order['order_id']; ?></b></a></td>
                <td class="center"><?php echo $order['date_added']; ?></td>
                <td class="center"><?php echo $order['order_status']; ?></td>
				<td class="right"><?php echo $order['order_total']; ?></td>
              </tr>
			...
			<tbody>
				<tr>
					<td colspan="3" class="right"><b><?php echo $column_orders_total; ?></b></td>
					<td class="right"><b><?php echo $total_cost; ?></b></td>
				</tr>
			</tbody>
          </table>
        </div>
