...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_telephone1'] = $this->language->get('entry_telephone1');
		...
		if (isset($this->error['telephone1'])) {
			$this->data['error_telephone1'] = $this->error['telephone1'];
		} else {
			$this->data['error_telephone1'] = '';
		}
		...
		if (isset($this->request->post['config_telephone1'])) {
			$this->data['config_telephone1'] = $this->request->post['config_telephone1'];
		} else {
			$this->data['config_telephone1'] = $this->config->get('config_telephone1');
		}
