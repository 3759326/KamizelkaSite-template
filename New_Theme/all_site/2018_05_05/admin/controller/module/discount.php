...
class ControllerModuleDiscount extends Controller {
	...
	public function index() {
		...
		if(($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()){
			$this->model_catalog_discount->editSetting( $this->request->post['discount']);
  ...
  //language
		...
		$this->data['text_fulltime_discount_i']       = $this->language->get('text_fulltime_i');
                $this->data['text_enabled_discount']         = $this->language->get('text_enabled_discount');
		$this->data['text_enabled_discount_i']       = $this->language->get('text_enabled_i');
		$this->data['text_discount_date']             = $this->language->get('text_discount_date');
                $this->data['text_discount_option']             = $this->language->get('text_discount_option');
                 $this->data['text_discount_option_all']             = $this->language->get('text_discount_option_all');
                 $this->data['text_discount_option_alls']             = $this->language->get('text_discount_option_alls');
                  $this->data['text_discount_option_leave']             = $this->language->get('text_discount_option_leave');
