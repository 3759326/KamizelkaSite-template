...
class ControllerSaleCustomer extends Controller { 
	...
	protected function getForm() {
		...
		$this->data['column_order_link'] = $this->language->get('column_order_link');
		...
		$results = $this->model_sale_customer->getOrder($this->request->get['customer_id']);

		foreach ($results as $result) {
			$this->data['orders'][] = array(
				'order_id'      => $result['order_id'],
				'date_added'    => $result['date_added'],
				'order_total'   => $this->currency->format($result['total']),
				'view_order'    => $this->url->link('sale/order/info', 'token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'], 'SSL'),
				'order_status'	=> $result['status'],
			);
		$summ += $result['total'];
		$this->data['total_cost'] = $this->currency->format($summ);
		}
	...
	/*public function order() {
		...
		$orders = $this->model_sale_customer->getOrder($this->request->get['customer_id']);
